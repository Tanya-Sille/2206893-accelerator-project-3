const selectFormContacts = document.querySelector('.form__select--contacts');
const selectFormModal = document.querySelector('.form__select--modal');

const activateSelect = (select) => {
...
const activateSelectContact = () => activateSelect(selectFormContacts);

const activateSelectModal = () => activateSelect(selectFormModal);

export {activateSelectContact, activateSelectModal};
